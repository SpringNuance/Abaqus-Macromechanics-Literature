...
data = np.genfromtxt('R_DD'+'.csv', delimiter=',')
data_strain = data[:,0]
r_val = data[:,1]
...
plt.title("Optimised Swift Voce curve extended to large strain for R-Value DD")
...
plt.xlabel("True Strain")
plt.ylabel("True Stress")
plt.title("Optimised Swift Voce curve for R-Value DD")
